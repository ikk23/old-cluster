...
"""
Use this file for parsing 2d_shredder_drives_spatial.slim file output.

Each individual .sh file will call this python script with:

python 2d_shredder_drives_parsing.py 2d_shredder_drives_spatial.slim <interest_drive>
...
def cfg_params():
    ...
    """
    # Default values:
    # may need to manually change these.
    capacity = 50000
    ...
    number_of_cells, no_drop, inbreeding_avoidance_factor, inbreeding_fecundity_penalty,\
    print_csv_header)
...
def main():
    ...
    for arg in sys.argv:
        ...
        if arg.startswith("inbreeding"):
            interest_param1 = ("Avoidance Factor", params[20])
            interest_param2 = ("Fecundity Penalty", params[21])
        if arg.startswith("all"):
            interest_param1 = ("Fitness", params[2])
            interest_param2 = ("Efficiency", params[6])
            interest_param3 = ("Beta", params[7])
            interest_param4 = ("Speed", params[13])
        if arg.startswith("resistance"):
            interest_param1 = ("R1 Rate", params[12])
