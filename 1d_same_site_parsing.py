...
"""
Use this file for parsing 1d_same_site_spatial.slim file output.

Each individual .sh file will call this python script with:

python 1d_same_site_parsing.py 1d_same_site_spatial.slim <interest_drive>
