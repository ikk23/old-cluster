...
"""
Use this file for parsing 1d_distant_site_spatial.slim file output.

Each individual .sh file will call this python script.

python 1d_distant_site_parsing.py 1d_distant_site_spatial.slim <interest_drive>
...
def cfg_params():
    ...
    for arg in sys.argv:
        ...
        if arg.startswith("efficiency="):
            ...
            embryo_resistance_rate = 0.95*germline_resistance_rate
    ...
    number_of_cells, no_drop, x_linked_drive, print_csv_header)
...
def main():
    ...
    params[22], params[23], params[24], params[25])
